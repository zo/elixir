...
if mode == 'source':
    ...
    if type == 'tree':
        ...
        print ('<table class="highlighttable"><tr><td class="linenos"><div class="linenodiv"><pre>')
        ...
        print ('</pre></div></td><td class="code"><div class="highlight"><pre>')
